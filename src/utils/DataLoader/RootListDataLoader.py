...
class RootListImageDataset(Dataset):
...
def get_root_list_dataloader(batch_size, image_root_list, image_transform, pin_memory=True, num_workers=0, shuffle=False):
    dataset = RootListImageDataset(image_root_list, image_transform)
